...
public class Main {
	...
	public static void main(String[] args) {
		...
		// EITHER make robot as a whole:
		//	robotEngineer.makeRobot();
		
		// OR make individual parts e.g. robot without head:
		robotEngineer.getRobotBuilder().buildRobotArms().buildRobotTorso().buildRobotLegs();
